...
import { DraftSeasonOneGroupB1x1 } from '../../../../components/league/table/DraftTableSeasons';
import { DraftSeasonOneGroupB2x2 } from '../../../../components/league/table/DraftTableSeasons';
import { DraftSeasonOneGroupB3x3 } from '../../../../components/league/table/DraftTableSeasons';
import { DraftSeasonOneGroupB4x4 } from '../../../../components/league/table/DraftTableSeasons';


const DraftTableB = () => {
	return (
		<div className='flex flex-col gap-5 mt-4'>
			<h3 className='text-xl pl-5'>Group B 1x1</h3>
			<DraftSeasonOneGroupB1x1 />
			<h3 className='text-xl pl-5 mt-16'>Group B 2x2</h3>
			<div>
				<div>
			...
			<DraftSeasonOneGroupB2x2 />
			<h3 className='text-xl pl-5 mt-16'>Group B 3x3</h3>
			<div>
				<div>
			...
			<DraftSeasonOneGroupB3x3 />
			<h3 className='text-xl pl-5 mt-16'>Group B 4x4</h3>
			<div>
			...
			<DraftSeasonOneGroupB4x4 />
			<div className='text-2xl'>Total Points:</div>
		</div>
	);
}

export default DraftTableB;