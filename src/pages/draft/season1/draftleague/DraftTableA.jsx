...
import { DraftSeasonOneGroupA1x1 } from '../../../../components/league/table/DraftTableSeasons';
import { DraftSeasonOneGroupA2x2 } from '../../../../components/league/table/DraftTableSeasons';
import { DraftSeasonOneGroupA3x3 } from '../../../../components/league/table/DraftTableSeasons';
import { DraftSeasonOneGroupA4x4 } from '../../../../components/league/table/DraftTableSeasons';
...
const DraftTableA = () => {
	return (
		<div className='flex flex-col gap-5 mt-4'>
			...
			<DraftSeasonOneGroupA1x1 />
			<h3 className='text-xl pl-5 mt-16'>Group A 2x2</h3>
			<div>
				<div>
