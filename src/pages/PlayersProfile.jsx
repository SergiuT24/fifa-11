...
const PlayersProfile = () => {
	const playersData = [
		...
		{ avatar: '/img/players/berserk.png', name: 'Berserk', id: '4180544', time: 'very active', goldenShoe: '/img/trophy/golden-shoe.png', goldenShoeCount: 'x1', proLeague: '/img/trophy/pro-league.png', proLeagueCount: 'x1', worldCup: '/img/trophy/world-cup.png', worldCupCount: 'x1' },
