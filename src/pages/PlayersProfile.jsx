...
const PlayersProfile = () => {
	const playersData = [
		{ avatar: '/img/players/anna.png', name: 'Anna', id: '11208470', time: 'very active', proLeague: '/img/trophy/pro-league.png', proLeagueCount: 'x1', ucl: '/img/trophy/champions-league.png', uclCount: 'x1', worldCup: '/img/trophy/world-cup.png', worldCupCount: 'x1' },
		...
		{ avatar: '/img/players/perfect.png', name: 'Perfect', id: '5459556', time: '21:00', proLeague: '/img/trophy/pro-league.png', proLeagueCount: 'x1', ucl: '/img/trophy/champions-league.png', uclCount: 'x1' },
