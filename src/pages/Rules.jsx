...
const Rules = () => {
	const russianRules = {
		"November 24/11/2024 New Rules": [
			"1.С момента записи на турнир игрок автоматически соглашается с обязательством доиграть турнир до конца. В случае, если он снимается с турнира после проведения жеребьёвки команд, ему будет наложен запрет на участие в следующим турнире!"
		],
