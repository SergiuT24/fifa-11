...
const Rules = () => {
	const russianRules = {
		...
		"Раздел лиги": [
			...
			"4. В случае, если две или более команды имеют одинаковое количество очков в конце лиги, места определяются по следующим критериям: Разница голов в матчах между собой. Разница голов в матчах против других команд. Количество забитых голов. Количество пропущенных голов."
		],
		"Лига чемпионов": [
