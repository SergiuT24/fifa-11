		...
		<div className='flex-1 flex justify-center'>
			<table>
				<thead style={{ backgroundColor: '#0f2d37' }}>
					<PlayerProfileTitle avatar={'Player Photo'} name={'Name'} id={'ID'} time={'Online (MSK)'} goldenShoe={`Golden Shoe`} balonDor={`Ballon d'or`} proLeague={'Pro League'} middleLeague={'Middle League'} ucl={'Champions League'} europe={'Europe League'} kingsCup={`King's Cup`} worldCup={'World Cup'} />
				</thead>
...
export default PlayersProfile1x1;
