	...
	return (
		<table>
			...
			<tbody style={{ backgroundColor: '#010a0f' }}>
				...
				<TableTeam rank={3.} img={<img className=' w-5 h-5' loading="lazy" alt="Germany" src="https://static.flashscore.com/res/image/data/0SofTgVH-fB4vYUZp.png" />} team={"Germany"} mp={0} w={0} d={0} l={0} g={0} gd={0} pts={0} form={<div className='flex gap-1 justify-center'><NotPlayedButton /><NotPlayedButton /><NotPlayedButton /><NotPlayedButton /></div>} />
			</tbody>
		</table>
	);
}
