...
const LatestNews = () => {
	return (
		<div className='latest-scores bg-white h-auto rounded-lg p-5 '>
			...
			<div className='grid grid-cols-4 gap-2'>
				<News
					...
					info={
						<div>
							<p>DartRin стал неоспоримым лидером и лучшим бомбардиром чемпионата мира FIFA 11, завоевав заслуженное признание благодаря своему впечатляющему рекорду в забитых мячах.</p>
							<p>За весь турнир DartRin забил в общей сложности 13 голов, что стало ярким проявлением его мастерства и способности находить решения в критических моментах.</p>
							<p>Каждый гол, забитый DartRin, становился важным шагом в направлении успеха для его команды.</p>
							<p>Поздравляем DartRin с заслуженным признанием лучшего бомбардира турнира FIFA 11 и благодарим за яркие выступления.</p>
						</div>
					}
				/>
				<News
