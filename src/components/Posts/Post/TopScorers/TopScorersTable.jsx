	...
	return (
		<table>
			...
			<tbody style={{ backgroundColor: '#010a0f' }}>
				<TopScorersLine rank={'1'} player={"DartRin"} team={"Spain"} g={"6"} />
				<TopScorersLine rank={'2'} player={"Anna"} team={"Spain"} g={"5"} />
				<TopScorersLine rank={'3'} player={"Jsnick"} team={"Brazil"} g={"3"} />
				<TopScorersLine rank={'4'} player={"Perfect"} team={"Brazil"} g={"1"} />
