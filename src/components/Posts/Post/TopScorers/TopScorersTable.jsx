	...
	return (
		<table>
			...
			<tbody style={{ backgroundColor: '#010a0f' }}>
				...
				<TopScorersLine rank={'5'} player={"Malemiria"} team={"Portugal"} g={"3"} />
				<TopScorersLine rank={'5'} player={"Perfect"} team={"Brazil"} g={"3"} />
				<TopScorersLine rank={'6'} player={"Box"} team={"England"} g={"2"} />
				<TopScorersLine rank={'6'} player={"Radenek"} team={"Germany"} g={"2"} />
				<TopScorersLine rank={'7'} player={"14_France"} team={"England"} g={"1"} />
				<TopScorersLine rank={'7'} player={"Sania"} team={"Portugal"} g={"1"} />
				<TopScorersLine rank={'7'} player={"Mark"} team={"Germany"} g={"1"} />
