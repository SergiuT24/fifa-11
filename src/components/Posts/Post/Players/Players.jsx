...
const Players = () => {
	return (
		<div className='player-block flex gap-11'>
			...
			<PlayersTeam team={'TEAM 3'} playerOne={'Radenek'} imgOne={'/img/players/law2020.png'} playerTwo={'Mark'} imgTwo={'/img/players/law2020.png'} flag={"https://static.flashscore.com/res/image/data/0SofTgVH-fB4vYUZp.png"} teamName={"Germany"} />
			...
			<PlayersTeam team={'TEAM 6'} playerOne={'Sania'} playerTwo={'Malemiria'} imgOne={'/img/players/law2020.png'} imgTwo={'/img/players/Malemiria.png'} flag={"https://static.flashscore.com/res/image/data/Grhsr8gT-vZG58BBc.png"} teamName={"Portugal"} />
		</div>
	);
}
