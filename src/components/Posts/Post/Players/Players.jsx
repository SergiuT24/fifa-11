...
const Players = () => {
	return (
		<div className='flex gap-11'>
			...
			<PlayersTeam team={'TEAM 3'} playerOne={'Wenger'} imgOne={'./players-img/Wenger.png'} playerTwo={'LAW2020'} imgTwo={'./players-img/law2020.png'} flag={"https://static.flashscore.com/res/image/data/0SofTgVH-fB4vYUZp.png"} teamName={"Germany"} />
