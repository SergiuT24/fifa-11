	...
	return (
		<div className='w-full overflow-x-auto'>
			<div className='player-block flex gap-3 sm:gap-6'>
				...
				<PlayersTeam team={'TEAM 3'} playerOne={'Radenek ID:1530641'} imgOne={'/img/players/avatar.png'} playerTwo={'Mark ID:'} imgTwo={'/img/players/avatar.png'} club={<ManchesterUnited/>}/>
				...
				<PlayersTeam team={'TEAM 8'} playerOne={'D.Drogba ID: 11701465'} playerTwo={'mysterio ID: 11701466'} imgOne={'/img/players/avatar.png'} imgTwo={'/img/players/avatar.png'} club={<BayernMunich/>}/>
			</div>
		</div>
	);
}
