	...
	return (
		<table>
			...
			<tbody style={{ backgroundColor: '#010a0f' }}>
				<TableTeam rank={1.} club={<AcMilan />} mp={3} w={2} d={0} l={1} g={7} gd={'7:1'} pts={6} form={<div className='flex gap-1 justify-center'><NotPlayedButton /><NotPlayedButton /><NotPlayedButton /><LoseButton title={'AC Milan 0:1 Manchester city'} /><WinButton title={'AC Milan 3:0 Arsenal'} /><WinButton title={'Arsenal 0:4 AC Milan'} /></div>} />
				<TableTeam rank={2.} club={<ManchesterCity />} mp={1} w={1} d={0} l={0} g={1} gd={'1:0'} pts={3} form={<div className='flex gap-1 justify-center'><NotPlayedButton /><NotPlayedButton /><NotPlayedButton /><NotPlayedButton /><NotPlayedButton /><WinButton title={'AC Milan 0:1 Manchester city'} /></div>} />
