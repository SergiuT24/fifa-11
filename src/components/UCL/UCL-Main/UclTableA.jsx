	...
	return (
		<table>
			...
			<tbody style={{ backgroundColor: '#010a0f' }}>
				...
				<TableTeam rank={4.} club={<BayernMunich />} mp={4} w={0} d={1} l={3} g={5} gd={'5:18'} pts={1} form={<div className='flex gap-1 justify-center'><NotPlayedButton /><NotPlayedButton /><LoseButton title={'Bayern Munich 2:6 Chelsea'} /><LoseButton title={'Chelsea 5:0 Bayern Munich'} /><LoseButton title={'Barcelona 5:1 Bayern Munich'} /><DrawButton title={'Bayern Munich 2:2 Barcelona'} /></div>} />
			</tbody>
		</table>
	);
}
