	...
	return (
		<table>
			...
			<tbody style={{ backgroundColor: '#010a0f' }}>
				...
				<TableTeam rank={4.} club={<ManchesterUnited />} mp={6} w={0} d={0} l={6} g={5} gd={'5:8'} pts={3} form={<div className='flex gap-1 justify-center'><LoseButton title={'Technical Lose Manchester United 0:3 Bayern Munich'} /><LoseButton title={'Technical Lose Bayern Munich 3:0 Manchester United'} /><LoseButton title={'Technical Lose Barcelona 3:0 Manchester United'} /><LoseButton title={'Technical Lose Manchester United 0:3 Barcelona'} /><LoseButton title={'Manchester United 2:6 Chelsea'} /><LoseButton title={'Technical Lose Chelsea 3:0 Manchester United'} /></div>} />
			</tbody>
		</table>
	);
}
