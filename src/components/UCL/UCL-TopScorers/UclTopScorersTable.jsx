	...
	return (
		<table>
			...
			<tbody style={{ backgroundColor: '#010a0f' }}>
				<TopScorersLine rank={'1'} player={"NSKRaven"} team={"AC Milan"} g={"7"} />
				<TopScorersLine rank={'2'} player={"Berserk"} team={"Chelsea"} g={"6"} />
				<TopScorersLine rank={'3'} player={"Malemiria"} team={"Barcelona"} g={"4"} />
				<TopScorersLine rank={'3'} player={"Sania"} team={"Barcelona"} g={"4"} />
				<TopScorersLine rank={'4'} player={"Anna"} team={"AC Milan"} g={"3"} />
				<TopScorersLine rank={'4'} player={"mcrurus"} team={"Chelsea"} g={"3"} />
				<TopScorersLine rank={'4'} player={"Radenek"} team={"Machester United"} g={"3"} />
				<TopScorersLine rank={'5'} player={"mysterio"} team={"Bayern Munich"} g={"2"} />
				<TopScorersLine rank={'5'} player={"Mark"} team={"Machester United"} g={"2"} />
				<TopScorersLine rank={'6'} player={"D.Drogba"} team={"Bayern Munich"} g={"1"} />
				<TopScorersLine rank={'6'} player={"Jsnick"} team={"Manchester City"} g={"1"} />
