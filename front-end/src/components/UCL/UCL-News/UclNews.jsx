	...
	return (
		<div className='latest-scores flex flex-col justify-center bg-white h-auto rounded-lg my-5'>
			...
			<div className='flex flex-col gap-5 items-center sm:grid sm:grid-cols-4 gap-2 p-6'>
				<News
					title={'Финал Лиги чемпионов завершился технической победой Баварии'}
					src={'https://i.ytimg.com/vi/KAwox6abVpM/maxresdefault.jpg'}
					info={
						<div>
							<p>Уважаемые участники турнира,</p>
							<p>Финал Лиги чемпионов между "Баварией" и "Барселоной" завершился технической победой "Баварии". Игроки "Барселоны" отказались играть из-за оскорблений от команды "Бавария".</p>
							<p>"Бавария" объявляется чемпионом Лиги чемпионов. Игроки "Барселоны" дисквалифицированы на один турнир. Игроки "Баварии" предупреждены: повторные нарушения приведут к дисквалификации.</p>
							<p>Будут приняты меры для улучшения регламента в будущих турнирах.</p>
						</div>
					}
				/>
				<News
					title={'Барселона выходит в финал Лиги чемпионов, обыграв АС Милан'}
					src={'https://m.psecn.photoshelter.com/img-get/I0000yIEExWzg530/s/750/750/2010-08-25-26744fv.jpg'}
					info={
						<div>
							<p>В полуфинале Лиги чемпионов Барселона встретилась с АС Милан. Первый матч, прошедший в Милане, завершился со счётом 1-0 в пользу АС Милан.</p>
							<p>Во втором матче, который проходил в Барселоне, хозяева одержали победу со счётом 2-0, что обеспечило им место в финале турнира.</p>
							...
							<p>Поздравляем Барселону с выходом в финал и благодарим АС Милан за достойную борьбу в этом захватывающем противостоянии.</p>
						</div>
					}
				/>
				<News
					title={'Барселона выходит в полуфинал Лиги чемпионов, обыграв Арсенал'}
					src={'https://i.guim.co.uk/img/static/sys-images/Football/Clubs/Club_Home/2011/3/8/1299616254777/Barcelona-v-Arsenal-Leo-M-007.jpg?width=465&dpr=1&s=none'}
					info={
						<div>
							<p>В четвертьфинале Лиги чемпионов Барселона встретилась с Арсеналом. Первый матч, прошедший в Лондоне, завершился со счётом 2-1 в пользу Барселоны.</p>
							<p>Во втором матче, который проходил в Барселоне, хозяева одержали победу со счётом 3-1, что обеспечило им место в полуфинале турнира.</p>
							<p>Игроки обеих команд продемонстрировали высокий уровень мастерства и приверженность игре, делая каждый матч захватывающим для болельщиков.</p>
							<p>Поздравляем Барселону с выходом в полуфинал и благодарим Арсенал за достойную борьбу в этом захватывающем противостоянии.</p>
						</div>
					}
				/>
				<News
